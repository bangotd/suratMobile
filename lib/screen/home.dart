...
import 'package:tutorial_app/pdfview.dart';
...
class _HomeState extends State<Home>{
  ...
  Future fetchAllPdf() async{
    final response = await http.get(url+'api/arsips');
        ...
        child:CircularProgressIndicator(),
          ...
          itemBuilder: (context, index) {
            return ListTile(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>PdfViewPage(url: url+"api/arsips/"+pdfList[index]["file"],title: pdfList[index]["title"],),),);
              },),
              title: Text(pdfList[index]["title"]),
            );
          },
      ),
